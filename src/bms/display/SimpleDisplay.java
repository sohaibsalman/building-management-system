...
public class SimpleDisplay {
    ...
    private static Building createBuilding() {
        ...
        /*
         * TODO you can modify the sample code below to create a list of
         * buildings for debugging purposes.
         *
         * Note that the sample code in this method will not compile until you
         ...
         *
         * Since all the code below is initially commented out, no floors,
         * rooms or sensors will display when you first run this class.
